export default function Phys131Page() {
    return (
      <div className="flex min-h-screen bg-white text-black">
        ...
        <main className="flex-1 px-12 py-10">
          <h1 className="text-3xl font-bold mb-4">PHYS 131- Introductory Physics for Life Sciences I</h1>
          <p className="text-lg text-gray-700">Welcome to your PHYS 131 course page.</p>
        </main>
      </div>
    );
  }
