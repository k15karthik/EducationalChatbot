export default function CS151Page() {
    return (
      <div className="flex min-h-screen bg-white text-black">
        ...
        <main className="flex-1 px-12 py-10">
          <h1 className="text-3xl font-bold mb-4">CS 151 — Mathematical Foundations of Computing</h1>
          <p className="text-lg text-gray-700">Welcome to your CS 151 course page.</p>
        </main>
      </div>
    );
  }
